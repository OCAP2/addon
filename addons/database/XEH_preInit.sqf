...
GVAR(allSettings) = [
  ...
  */
  [
    ...
    [
      localize LSTRING(DatabaseRecordingEnabled), // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
      localize LSTRING(DatabaseRecordingEnabled_Tooltip)
    ],
