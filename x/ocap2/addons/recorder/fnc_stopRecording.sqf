...
[[cba_missionTime, format _missionDateFormat, format _systemTimeFormat], { // add diary entry for clients on recording pause
  [{!isNull player}, {
    player createDiaryRecord [
      ...
      [
        "Status",
        format["<font color='#33FF33'>OCAP2 stopped recording.<br/>In-Mission Time Elapsed: %1<br/>Mission World Time: %2<br/>System Time UTC: %3</font>", _this#0, _this#1, _this#2]
      ], taskNull, "", false
    ];
