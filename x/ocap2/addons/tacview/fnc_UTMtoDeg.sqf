...
/*
convert xy to polar
latlng plus angle and range

https://www.mathsisfun.com/polar-cartesian-coordinates.html#summary

quadrant two (counterclockwise first) is add 180 degrees
quadrant four (counterclockwise last) is add 360 degrees
*/
